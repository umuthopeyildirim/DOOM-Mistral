    ...
    for i in range(episodes):
        ...
        while not game.is_episode_finished():
            ...
            def print_label(label):
                print('xywh: ', label.x, label.y, label.width, label.height)
                print('value: ', label.value)
                print('object_name: ', label.object_name)
                #print('xyz: ', label.objectPositionX, label.objectPositionY, label.objectPositionZ)
            print(print_label(state.labels[0]))
            print(state.objects)
            print(state.sectors)
            exit()
